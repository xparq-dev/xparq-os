// XPARQ OS - Phase 02: Simple x86_64 Bootloader
...
/// Bootloader entry point for x86_64
#[no_mangle]
pub extern "C" fn _start() -> ! {
    ...
    unsafe {
        ...
        let kernel_entry: extern "C" fn(KernelArgs) -> ! = 
            core::mem::transmute(0x100000usize); // Dummy kernel address
...
pub extern "C" fn kernel_main(boot_info: &BootInfo) -> ! {
    ...
    if let Some(_fb) = boot_info.framebuffer {
        println!("Framebuffer: {}x{} @ 0x{:x}", 1024, 768, 0x10000000);
    }
